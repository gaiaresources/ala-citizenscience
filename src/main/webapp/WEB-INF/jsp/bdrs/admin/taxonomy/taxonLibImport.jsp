...
<div>
	<p>
		...
		<a href="${portalContextPath}/user/editProfile.htm">profile</a>.
	</p>
	<p>
...
<ul>
    <li>
        <a href="${portalContextPath}/bdrs/admin/taxonomy/nswFloraImport.htm">
            NSW Flora
        </a>
    </li>
    <li>
    ...
    <li>
        <a href="${portalContextPath}/bdrs/admin/taxonomy/afdImport.htm">
