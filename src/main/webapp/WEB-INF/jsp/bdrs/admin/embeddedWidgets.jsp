...
<p>
	Here you can create widgets to add to this site or any other site. You can currently create two types of widgets:
</p>
<ul>
	<li>a 'Latest Statistics' widget that will report the number of users, records, and species in the system</li>
