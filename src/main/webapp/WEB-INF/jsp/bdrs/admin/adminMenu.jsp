...
<ul>
    <sec:authorize ifAnyGranted="ROLE_ADMIN,ROLE_ROOT,ROLE_SUPERVISOR">
	    <li>
	        <a href="${portalContextPath}/bdrs/admin/managePeople.htm">Manage People</a>
	        - Click here to edit users and user groups or to approve user accounts or email users.
	    </li>
    </sec:authorize>
    <li>
        <a href="${portalContextPath}/bdrs/admin/manageProjects.htm">Manage Projects</a>
    ...
    <sec:authorize ifAnyGranted="ROLE_ADMIN,ROLE_ROOT">
	    <li>
	        <a href="${portalContextPath}/bdrs/admin/manageData.htm">Manage Data</a>
	        - Click here to manage data preferences and thresholds or to download data and species pages.
	    </li>
	    <li>
	        <a href="${portalContextPath}/bdrs/admin/managePortal.htm">Manage Portal</a>
    ...
    <sec:authorize ifAnyGranted="ROLE_ADMIN,ROLE_ROOT,ROLE_SUPERVISOR,ROLE_POWER_USER">
	    <li>
	        <a href="${portalContextPath}/bdrs/admin/embeddedWidgets.htm">Embedded Widgets</a>
