...
<form id="themeElementForm" method="POST" action="">
    ...
    <div class="textright buttonpanel">
        <a href="${portalContextPath}/bdrs/<c:if test="${editAsRoot}">root</c:if><c:if test="${editAsAdmin}">admin</c:if>/theme/edit.htm?portalId=${ editTheme.portal.id }&themeId=${ editTheme.id }">Cancel</a>
        <span>&nbsp;|&nbsp;</span>
