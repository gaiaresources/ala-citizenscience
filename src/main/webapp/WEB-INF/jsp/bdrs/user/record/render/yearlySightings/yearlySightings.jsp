                                ...
                                <c:when test="${date != null}">
                                    ...
                                    >
                                       <c:choose>
                                            <c:when test="${recordWebFormContext.editable}">
                                                <c:choose>
                                                    <c:when test="<%= (date.before(today) || date.equals(today)) && (date.after(survey.getStartDate()) || date.equals(survey.getStartDate())) && (survey.getEndDate() == null || (date.before(survey.getEndDate()) || date.equals(survey.getEndDate()))) %>">
