...
(function($){
  ...
  $.fn.placeholder = function(options) {
    ...
    return (hasPlaceholder) ? this : this.each(function() {
      ...
      // CODE ADDED - NOT FROM ORIGINAL REPOSITORY
      // remove the placeholder attribute to prevent the browser from trying to use it as the input value
      // required for $.serialize() to work
