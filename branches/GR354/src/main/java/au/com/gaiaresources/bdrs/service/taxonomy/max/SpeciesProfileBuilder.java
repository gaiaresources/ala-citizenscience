...
/**
 * Creates a SpeciesProfile from a Max Name Row by storing the column value as text.
 */
public class SpeciesProfileBuilder {

    private String header;
    private MaxNameRow.ColumnName columnName;
     ...
     */
    public SpeciesProfileBuilder(MaxNameRow.ColumnName columnName, String header) {
     ...
     */
    public SpeciesProfile createProfile(MaxNameRow nameRow) {
