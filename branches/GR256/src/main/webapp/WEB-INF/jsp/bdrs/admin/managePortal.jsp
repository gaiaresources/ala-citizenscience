...
<p>This is the starting point for the Administrator to manage the entire Portal settings.  This includes:</p>
...
<ul>
	...
	<li><a href="${portalContextPath}/bdrs/user/managedfile/listing.htm">Manage Files</a>&nbsp; - where files that are to be used elsewhere - like in the Theme - can be loaded to the system</li>
	<li><a href="${portalContextPath}/bdrs/public/embedded/widgetBuilder.htm">Manage Widgets</a>&nbsp; - widgets are plugins that enable statistics and other functions from the Portal to be embedded in other web sites</li>
</ul>
