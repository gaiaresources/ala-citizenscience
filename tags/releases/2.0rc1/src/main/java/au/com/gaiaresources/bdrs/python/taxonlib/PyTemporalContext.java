package au.com.gaiaresources.bdrs.python.taxonlib;
...
public class PyTemporalContext {
     ...
     *
     * @param startDateString start date as an ISO date string
     * @param endDateString end date as an ISO date string
