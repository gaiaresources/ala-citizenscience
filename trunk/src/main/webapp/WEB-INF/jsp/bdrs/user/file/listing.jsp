...
<script type="text/javascript">
    ...
    jQuery(function() {
	    ...
	    jQuery("#managedFilesList").jqGrid({
	            ...
	            colNames:['Id', 'Identifier','Last Modified', 'User', 'Filename / Download', 'Preview', 'Action'],
	            colModel:[
	                {name:'id', hidden:true, key:true},
	                {name:'uuid',sortable:false, width:'10%'},
	                {name:'updatedAt',index:'file.updatedAt', sorttype:'date', width:'10%'},
	                {name:'updatedBy.name',index:'updatedBy.firstName', width:'10%'},
	                {name:'filename', index:'filename', width: '30px', formatter:filenameFormatter},
	              //  {name:'description', width:50 , index:'description'},
	                {name:'fileURL', width:'10%', sortable: false, formatter:previewFormatter, valign:'center'},
	                {name:'action', width:'30px', sortable:false, formatter:actionLinkFormatter, align:'center'}
	            ],
	            height: '100%',
	            autowidth: true,
